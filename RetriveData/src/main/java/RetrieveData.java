...
//            System.out.println(Arrays.toString(groups));
    ...
    public static void main (String[] args) throws Exception{
        ...
        Long siteIdXX = instance.getSiteIdRandom(siteIds);
        List<Long> resourceIdsXX = instance.listResourcesIds(siteIdXX);
        Long resourceIdXX = instance.getResourceIdRandom(resourceIdsXX);
