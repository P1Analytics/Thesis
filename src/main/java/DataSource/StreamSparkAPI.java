...
//        GET /v1/resource/{resourceId} Retrieve a Spark Works Resource Details by its unique identifier
    ...
    private void getresouceIDTag(Long resourceId) throws Exception, AssertionError {
...
//      TODO  no tag in the raw data yet
    ...
    private void getResourceIdDetails(Long resourceId , String detail) throws Exception, AssertionError {
//        GET /v1/resource/{resourceId} Retrieve a Spark Works Resource Details by its unique identifier
...
//            System.out.println("resouceId "+ resourceId + " : " + from(response).get(detail));
    ...
    private void getResourceLatest(Long resourceId,String latest_item) throws Exception,AssertionError {
//        GET /v1/resource/{resourceId}/latest Retrieve latest values of a Resource
    ...
    private void getResourceSummary(Long resourceId,String frequency) throws Exception,AssertionError {
...
//        TODO same out for adding Uom with ID
    ...
    private void getResourceDataByDayRange(Long resourceId, ZonedDateTime start, ZonedDateTime end, String frequency) throws Exception,AssertionError {
        ...
        String requestBody = "" +
                ...
                "\"queries\": [" +
                "{" +
                "\"from\": " + start.toInstant().toEpochMilli()/300000*300000 + "," + // i want take sample for every 5,10,15,..55, 00 min
...
//                System.out.println(reading);
    ...
    public static void main (String[] args) throws Exception {
        StreamSparkAPI instance = new StreamSparkAPI();
        instance.setUp();
...
//        instance.getResourceDataByDayRange(147621L, start, end, "hour");
//        System.out.println("Check out the resources data" + matches);
        ...
        for (Long siteId : siteIds){
            ...
            for (Long resourceId: resourcesIds){
                instance.getResourceIdDetails(resourceId,"property");
//                instance.getResourceLatest(resourceId,"latestMonth");
//                instance.getResourceSummary(resourceId,"max");
                instance.getResourceDataByDayRange(resourceId, start, end, "hour");
//                instance.getResourceDataByDayRange(resourceId, start, end, "5min");
//                return;
            }
        }
